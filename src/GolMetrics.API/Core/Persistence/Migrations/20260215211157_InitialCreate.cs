    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    encrypted_api_key = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_cached_queries", x => x.id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_cached_queries_expires_at",
                table: "cached_queries",
                column: "expires_at");

            migrationBuilder.CreateIndex(
                name: "ix_cached_queries_query_hash",
                table: "cached_queries",
                column: "query_hash",
                unique: true);
