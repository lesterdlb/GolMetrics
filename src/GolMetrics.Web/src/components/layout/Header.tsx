...
export const Header = () => {
  ...
  return (
    <header className="mb-6 relative w-full max-w-[960px] flex items-center justify-between shrink-0 z-20">
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[200px] h-[60px] bg-white/5 blur-2xl rounded-full pointer-events-none" />
      ...
      <div className="flex gap-3">
        <Button
          variant="glass"
          size="icon"
          className={`rounded-xl ${isOnSettings ? 'border-primary/50 bg-primary/20' : ''}`}
