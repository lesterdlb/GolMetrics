...
function App() {
    ...
    return (
        <div className="relative h-screen w-full flex flex-col items-center justify-center p-4 md:p-8 font-sans">
            ...
            <main
                className="w-full max-w-[960px] flex-1 flex flex-col bg-black/75 backdrop-blur-xl rounded-2xl border border-primary/50 shadow-[0_0_25px_rgba(77,142,255,0.15)] overflow-hidden relative group z-10 transition-all duration-500">
                <div
                    className="absolute inset-0 rounded-2xl border border-primary/30 pointer-events-none shadow-[inset_0_0_20px_rgba(77,142,255,0.1)]"></div>
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-10 space-y-8 scrollbar-hide relative z-10">
                    <div className="flex justify-center mb-8 sticky top-0 z-20">
                        <div
                            className="px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-gray-400 uppercase tracking-widest backdrop-blur-md shadow-lg">
                ...
                <div className="p-5 md:p-6 bg-white/5 backdrop-blur-xl border-t border-white/10 relative z-20">
                    <form onSubmit={handleSend} className="flex gap-4 items-center relative">
                        <div className="relative flex-1 group/input">
                            <div
                                className="absolute inset-0 bg-gradient-to-r from-primary/20 to-transparent opacity-0 group-hover/input:opacity-100 transition-opacity rounded-xl pointer-events-none"></div>
                            <input
                                type="text"
                                value={inputValue}
            ...
            <span className="text-[10px] text-gray-500 font-mono tracking-widest uppercase flex items-center gap-1.5">
              ...
              Live Data
                        ...
                        <span
                            className="text-[10px] text-gray-500 font-mono tracking-widest uppercase flex items-center gap-1.5">
