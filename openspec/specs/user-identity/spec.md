...
Defines the User entity (ASP.NET Identity integration), permission constants, permission-based authorization infrastructure, and Identity/JWT service registration.
